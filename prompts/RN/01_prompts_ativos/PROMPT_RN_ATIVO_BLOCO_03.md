# Prompt de Pesquisa - RN - Bloco 3/5
...
- nome_polo_ou_campus_bruto: Serra de São Bento
- municipio_polo_bruto: Serra de São Bento
...
- instituicao_bruta: UFERSA
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Polo Educa Grossos
- municipio_polo_bruto: Grossos
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- instituicao_bruta: UFERSA
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Polo Natal
...
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Campus de Currais Novos
- municipio_polo_bruto: Currais Novos
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- instituicao_bruta: UFRN
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Polo de Marcelino Vieira
- municipio_polo_bruto: Marcelino Vieira
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
