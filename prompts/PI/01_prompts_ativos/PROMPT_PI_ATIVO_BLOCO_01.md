# Prompt de Repesquisa - PI - Bloco 1/9
...
- nome_polo_ou_campus_bruto: Polo de Anísio de Abreu
- municipio_polo_bruto: Anísio de Abreu
- curso_alvo: Licenciatura em Matematica
- status_anterior: HTML_INTERMEDIARIO
- url_fonte_anterior: https://legcead.ufpi.br/index.php/matematica
- url_download_anterior: https://sigaa.ufpi.br/sigaa/verProducao?idProducao=210544&key=6ac3fbdec53a0d9391908017fbeebc43
...
- instituicao_bruta: IFPI
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: POLO DA UAB DE BARRAS
- municipio_polo_bruto: Barras
- curso_alvo: Licenciatura em Matematica
- status_anterior: HTML_INTERMEDIARIO
- url_fonte_anterior: https://legcead.ufpi.br/index.php/matematica
- url_download_anterior: https://sigaa.ufpi.br/sigaa/verProducao?idProducao=210544&key=6ac3fbdec53a0d9391908017fbeebc43
...
- instituicao_bruta: IFPI
- modalidade_bruta: Educação Presencial
- nome_polo_ou_campus_bruto: Campus Campo Maior do Instituto Federal do Piauí
...
- instituicao_bruta: IFPI
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Polo Manoel Marques de Araujo
- municipio_polo_bruto: Canto do Buriti
- curso_alvo: Licenciatura em Matematica
- status_anterior: HTML_INTERMEDIARIO
- url_fonte_anterior: https://ufpi.br/matematica-cead
- url_download_anterior: https://sigaa.ufpi.br/sigaa/verProducao?idProducao=210544&key=6ac3fbdec53a0d9391908017fbeebc43
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- instituicao_bruta: IFPI
- modalidade_bruta: Educação Presencial
- nome_polo_ou_campus_bruto: Campus Corrente do Instituto Federal do Piauí
...
- instituicao_bruta: IFPI
- modalidade_bruta: Educação Presencial
- nome_polo_ou_campus_bruto: Campus Floriano do Instituto Federal do Piauí
- municipio_polo_bruto: Floriano
