# Prompt de Repesquisa - PI - Bloco 6/9
...
- nome_polo_ou_campus_bruto: Polo de Apoio Presencial - José de Freitas-PI
- municipio_polo_bruto: José de Freitas
...
- instituicao_bruta: UFPI
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Polo de Apoio Presencial - Paes Landim-PI
- municipio_polo_bruto: Paes Landim
- curso_alvo: Licenciatura em Matematica
- status_anterior: HTML_INTERMEDIARIO
...
- instituicao_bruta: UFPI
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Polo de Apoio Presencial - Palmeirais-PI
- municipio_polo_bruto: Palmeirais
- curso_alvo: Licenciatura em Matematica
- status_anterior: HTML_INTERMEDIARIO
...
- instituicao_bruta: UFPI
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Polo UAB - PIRIPIRI
...
- modalidade_bruta: Educação Presencial
- nome_polo_ou_campus_bruto: Campus Cocal do Instituto Federal do Piauí
- municipio_polo_bruto: Cocal
- curso_alvo: Licenciatura em Matematica
- status_anterior: NAO_ENCONTRADO
- url_fonte_anterior: https://www.even3.com.br/iisemmat-632540/
