# Prompt de Repesquisa - PI - Bloco 5/10
...
- instituicao_bruta: IFPI
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: POLO UAB DE CORRENTE - CENTRO
...
- instituicao_bruta: IFPI
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Polo Chapada das Mangabeira
...
- instituicao_bruta: IFPI
- modalidade_bruta: Educação Presencial
- nome_polo_ou_campus_bruto: Campus Piripiri do Instituto Federal do Piauí
