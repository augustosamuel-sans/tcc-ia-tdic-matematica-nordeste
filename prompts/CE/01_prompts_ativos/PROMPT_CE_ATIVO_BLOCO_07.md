# Prompt de Pesquisa - CE - Bloco 7/11
...
- nome_polo_ou_campus_bruto: Campus Limoeiro do Norte
...
- nome_polo_ou_campus_bruto: ESCOLA RUBENS VAZ (JUREMA)
...
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Polo UAB - OROS
- municipio_polo_bruto: Orós
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- instituicao_bruta: IFCE
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Polo UAB Camocim
- municipio_polo_bruto: Camocim
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- instituicao_bruta: UECE
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: POLO UAB - MARACANAU
- municipio_polo_bruto: Maracanaú
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- instituicao_bruta: UECE
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: BARBALHA - BURITI
- municipio_polo_bruto: Barbalha
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- instituicao_bruta: UECE
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Escola Álvaro de Araújo Carneiro
- municipio_polo_bruto: Madalena
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
