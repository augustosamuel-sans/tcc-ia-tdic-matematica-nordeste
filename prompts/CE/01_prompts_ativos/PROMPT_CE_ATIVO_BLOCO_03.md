# Prompt de Pesquisa - CE - Bloco 3/11
...
### Item 1
- estado: CE
- instituicao_bruta: URCA
- modalidade_bruta: Educação Presencial
- nome_polo_ou_campus_bruto: Unidade Descentralizada de Campos Sales
- municipio_polo_bruto: Campos Sales
...
- nome_polo_ou_campus_bruto: EDIONES BESERRA DOS SANTOS
- municipio_polo_bruto: Lavras da Mangabeira
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- modalidade_bruta: Educação Presencial
- nome_polo_ou_campus_bruto: Campus Juazeiro do Norte
- municipio_polo_bruto: Juazeiro do Norte
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Polo UAB - BEBERIBE
- municipio_polo_bruto: Beberibe
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
### Item 6
- estado: CE
- instituicao_bruta: UVA
- modalidade_bruta: Educação Presencial
- nome_polo_ou_campus_bruto: Campus Cidao
- municipio_polo_bruto: Sobral
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- instituicao_bruta: UECE
- modalidade_bruta: Educação Presencial
- nome_polo_ou_campus_bruto: CAMPUS DO ITAPERI
