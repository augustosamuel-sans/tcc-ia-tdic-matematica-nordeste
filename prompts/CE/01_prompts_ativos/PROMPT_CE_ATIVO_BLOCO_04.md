# Prompt de Pesquisa - CE - Bloco 4/11
...
- nome_polo_ou_campus_bruto: Polo UAB - PIQUET CARNEIRO
- municipio_polo_bruto: Piquet Carneiro
...
- instituicao_bruta: UECE
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Local: Polo UAB de Canindé
...
- nome_polo_ou_campus_bruto: Campus Cedro
- municipio_polo_bruto: Cedro
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- instituicao_bruta: IFCE
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Pólo Meruoca
- municipio_polo_bruto: Meruoca
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- instituicao_bruta: IFCE
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Polo Universitário UAB Tauá
- municipio_polo_bruto: Tauá
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
