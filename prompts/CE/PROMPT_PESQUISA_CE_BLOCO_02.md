# Prompt de Pesquisa - CE - Bloco 2/11
...
- nome_polo_ou_campus_bruto: Polo UAB de Jaguaribe
- municipio_polo_bruto: Jaguaribe
...
- nome_polo_ou_campus_bruto: Campus Sobral
...
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Iguatu
...
- instituicao_bruta: IFCE
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Polo UAB - Itapipoca
- municipio_polo_bruto: Itapipoca
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
