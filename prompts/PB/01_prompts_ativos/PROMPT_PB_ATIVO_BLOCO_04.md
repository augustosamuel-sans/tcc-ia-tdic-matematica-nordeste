# Prompt de Pesquisa - PB - Bloco 4/5
...
- nome_polo_ou_campus_bruto: Polo UAB - JOAO PESSOA
...
- instituicao_bruta: UFPB
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Polo UAB - ITAPORANGA
- municipio_polo_bruto: Itaporanga
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- nome_polo_ou_campus_bruto: Campus VII
- municipio_polo_bruto: Patos
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- instituicao_bruta: UEPB
- modalidade_bruta: Educação Presencial
- nome_polo_ou_campus_bruto: UEPB - Sede - Campus I
...
- instituicao_bruta: UFPB
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Polo UAB - POMBAL
- municipio_polo_bruto: Pombal
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- instituicao_bruta: UFPB
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Polo UAB - TAPEROA
- municipio_polo_bruto: Taperoá
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
