# Prompt de Pesquisa - PB - Bloco 3/5
...
- nome_polo_ou_campus_bruto: Polo UAB - COREMAS
- municipio_polo_bruto: Coremas
...
- instituicao_bruta: UFPB
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Polo UAB - ARARUNA
- municipio_polo_bruto: Araruna
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
### Item 3
- estado: PB
- instituicao_bruta: UFCG
- modalidade_bruta: Educação Presencial
- nome_polo_ou_campus_bruto: Campus de Cajazeiras
- municipio_polo_bruto: Cajazeiras
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- instituicao_bruta: UFPB
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Polo UAB - ITABAIANA
...
- instituicao_bruta: UFCG
- modalidade_bruta: Educação Presencial
- nome_polo_ou_campus_bruto: POLO NA SEDE
- municipio_polo_bruto: Campina Grande
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- instituicao_bruta: UFPB
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Polo UAB - SAO BENTO
- municipio_polo_bruto: São Bento
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
