# Prompt de Pesquisa - PE - Bloco 1/4
...
- nome_polo_ou_campus_bruto: Campus Ouricuri
- municipio_polo_bruto: Ouricuri
...
- nome_polo_ou_campus_bruto: Polo UAB - SANTA CRUZ DO CAPIBARIBE
- municipio_polo_bruto: Santa Cruz do Capibaribe
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Carpina - São José
- municipio_polo_bruto: Carpina
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- instituicao_bruta: IFPE
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Polo de Apoio Presencial de Sertânia
- municipio_polo_bruto: Sertânia
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- instituicao_bruta: IF SERTÃO-PE
- modalidade_bruta: Educação Presencial
- nome_polo_ou_campus_bruto: Santa Maria da Boa Vista
- municipio_polo_bruto: Santa Maria da Boa Vista
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- instituicao_bruta: UFPE
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Recife - Madalena
...
### Item 7
- estado: PE
- instituicao_bruta: FACHUSC
- modalidade_bruta: Educação Presencial
- nome_polo_ou_campus_bruto: FACHUSC
- municipio_polo_bruto: Salgueiro
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
