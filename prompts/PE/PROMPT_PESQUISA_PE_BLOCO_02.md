# Prompt de Pesquisa - PE - Bloco 2/4
...
- nome_polo_ou_campus_bruto: Garanhuns - Santo Antônio
...
- instituicao_bruta: UFPE
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Tabira - Jureminha
- municipio_polo_bruto: Tabira
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- nome_polo_ou_campus_bruto: Campus Universitário Cidade do Recife
...
- modalidade_bruta: Educação Presencial
- nome_polo_ou_campus_bruto: IFPE  - CAMPUS DE PESQUEIRA
...
- instituicao_bruta: IFPE
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Campus Recife
- municipio_polo_bruto: Recife
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
