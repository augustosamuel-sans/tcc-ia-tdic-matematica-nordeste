# Prompt de Repesquisa - BA - Bloco 11/14
...
- nome_polo_ou_campus_bruto: Polo UAB - IBOTIRAMA
...
- instituicao_bruta: UNEB
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: IPIAÚ - UAB
- municipio_polo_bruto: Ipiaú
- curso_alvo: Licenciatura em Matematica
- status_anterior: NAO_ENCONTRADO
- url_fonte_anterior: https://unead.uneb.br/index.php/matematica/
- url_download_anterior: NAO_ENCONTRADO
...
- instituicao_bruta: UNEB
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Polo UAB - IRECE
...
- instituicao_bruta: UNEB
- modalidade_bruta: Educação Presencial
- nome_polo_ou_campus_bruto: Campus XIII - Itaberaba
- municipio_polo_bruto: Itaberaba
- curso_alvo: Licenciatura em Matemática
- status_anterior: NAO_ENCONTRADO
- url_fonte_anterior: https://feiradegraduacao.uefs.br/licenciatura-em-matematica/
- url_download_anterior: NAO_ENCONTRADO
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- instituicao_bruta: UNEB
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Polo UAB - ITABERABA
- municipio_polo_bruto: Itaberaba
- curso_alvo: Licenciatura em Matemática
- status_anterior: NAO_ENCONTRADO
...
- instituicao_bruta: UNEB
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: ITAMARAJU - UAB
