# Prompt de Repesquisa - BA - Bloco 12/14
...
- nome_polo_ou_campus_bruto: Polo UAB - ITANHEM
- municipio_polo_bruto: Itanhém
...
- nome_polo_ou_campus_bruto: Campus IV - Jacobina
- municipio_polo_bruto: Jacobina
- curso_alvo: Licenciatura em Matematica
- status_anterior: NAO_ENCONTRADO
- url_fonte_anterior: https://unead.uneb.br/index.php/matematica/
- url_download_anterior: NAO_ENCONTRADO
...
- instituicao_bruta: UNEB
- modalidade_bruta: Educação Presencial
- nome_polo_ou_campus_bruto: Jeremoabo
- municipio_polo_bruto: Jeremoabo
- curso_alvo: Licenciatura em Matematica
- status_anterior: NAO_ENCONTRADO
...
- instituicao_bruta: UNEB
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Macaúbas
- municipio_polo_bruto: Macaúbas
- curso_alvo: Licenciatura em Matematica
- status_anterior: NAO_ENCONTRADO
...
- instituicao_bruta: UNEB
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Polo Mata de São João
