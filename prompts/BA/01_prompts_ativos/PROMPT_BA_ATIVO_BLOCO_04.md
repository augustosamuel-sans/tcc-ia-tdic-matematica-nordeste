# Prompt de Repesquisa - BA - Bloco 4/14
...
- nome_polo_ou_campus_bruto: Campus X - Teixeira de Freitas
- municipio_polo_bruto: Teixeira de Freitas
...
- nome_polo_ou_campus_bruto: Polo UAB de Dias D' Ávila
- municipio_polo_bruto: Dias d´Ávila
- curso_alvo: Licenciatura em Matematica
- status_anterior: NAO_ENCONTRADO
- url_fonte_anterior: https://dcet.alagoinhas.uneb.br/matematica/
...
- instituicao_bruta: IFBA
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Polo UAB de Euclides da Cunha
...
- instituicao_bruta: IFBA
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Polo UAB - Lauro de Freitas
- municipio_polo_bruto: Lauro de Freitas
- curso_alvo: Licenciatura em Matematica
- status_anterior: NAO_ENCONTRADO
...
- instituicao_bruta: IFBA
- modalidade_bruta: Educação Presencial
- nome_polo_ou_campus_bruto: CAMPUS DE VALENÇA
