# Prompt de Pesquisa - MA - Bloco 9/9
...
- nome_polo_ou_campus_bruto: U.E.M. Raio de Sol
- municipio_polo_bruto: São Mateus do Maranhão
...
- modalidade_bruta: Educação Presencial
- nome_polo_ou_campus_bruto: BARRA DO CORDA
- municipio_polo_bruto: Barra do Corda
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- instituicao_bruta: UEMA
- modalidade_bruta: Educação Presencial
- nome_polo_ou_campus_bruto: Turiaçu Complexo Educacional Ieda Viana Ribeiro
- municipio_polo_bruto: Turiaçu
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- nome_polo_ou_campus_bruto: PÓLO DE IMPERATRIZ
- municipio_polo_bruto: Imperatriz
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- instituicao_bruta: IFMA
- modalidade_bruta: Educação Presencial
- nome_polo_ou_campus_bruto: CAMPUS ZE DOCA
