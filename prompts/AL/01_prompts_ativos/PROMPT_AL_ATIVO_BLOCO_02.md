# Prompt de Pesquisa - AL - Bloco 2/4
...
- nome_polo_ou_campus_bruto: POLO UAB-PENEDO
- municipio_polo_bruto: Penedo
...
### Item 2
- estado: AL
- instituicao_bruta: IFAL
- modalidade_bruta: Educação Presencial
- nome_polo_ou_campus_bruto: Campus e Polo UAB - Maceió
- municipio_polo_bruto: Maceió
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- instituicao_bruta: UNCISAL
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: POLO UAB MATRIZ DE CAMARAGIBE
- municipio_polo_bruto: Matriz de Camaragibe
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- instituicao_bruta: UNCISAL
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: POLO UAB PALMEIRA DOS ÍNDIOS
- municipio_polo_bruto: Palmeira dos Índios
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- instituicao_bruta: UNCISAL
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: POLO UAB SÃO JOSÉ DA LAJE
- municipio_polo_bruto: São José da Laje
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- modalidade_bruta: Educação Presencial
- nome_polo_ou_campus_bruto: CAMPUS ARAPIRACA - Sede
...
- instituicao_bruta: UFAL
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: CAMPUS A. C. SIMÕES
- municipio_polo_bruto: Maceió
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
