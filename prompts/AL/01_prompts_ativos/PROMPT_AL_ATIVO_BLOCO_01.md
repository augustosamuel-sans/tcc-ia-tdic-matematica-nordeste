# Prompt de Pesquisa - AL - Bloco 1/4
...
### Item 1
- estado: AL
- instituicao_bruta: UNCISAL
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: POLO UAB SANTANA DO IPANEMA
- municipio_polo_bruto: Santana do Ipanema
...
### Item 2
- estado: AL
- instituicao_bruta: UFAL
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: POLO UAB - OLHO D'AGUA DAS FLORES
- municipio_polo_bruto: Olho d´Água das Flores
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- instituicao_bruta: UNCISAL
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: POLO UAB-DELMIRO GOUVEIA
- municipio_polo_bruto: Delmiro Gouveia
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: PÓLO UAB - SANTANA DO IPANEMA
- municipio_polo_bruto: Santana do Ipanema
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
...
- instituicao_bruta: UFAL
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: Campus do Sertão - UNIDADE EDUCACIONAL DE SANTANA DO IPANEMA
- municipio_polo_bruto: Santana do Ipanema
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
...
- instituicao_bruta: UNCISAL
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: POLO UAB-CAJUEIRO
- municipio_polo_bruto: Cajueiro
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
