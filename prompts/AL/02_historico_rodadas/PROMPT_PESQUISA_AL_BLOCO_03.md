# Prompt de Pesquisa - AL - Bloco 3/4
...
- nome_polo_ou_campus_bruto: POLO UAB ARAPIRACA
...
- nome_polo_ou_campus_bruto: PÓLO ARAPIRACA
- municipio_polo_bruto: Arapiraca
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
...
- instituicao_bruta: UNCISAL
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: POLO UAB OLHO DÁGUA DAS FLORES
...
- modalidade_bruta: Educação Presencial
- nome_polo_ou_campus_bruto: Campus e Polo UAB - Piranhas
- municipio_polo_bruto: Piranhas
- curso_alvo: Licenciatura em Matematica
- precisa_ano_ppc: sim
- precisa_url_fonte: sim
- precisa_url_download_pdf: sim
...
- instituicao_bruta: UNCISAL
- modalidade_bruta: Educação a Distância
- nome_polo_ou_campus_bruto: CAMPUS  - MACEIÓ - TRAPICHE DA BARRA
